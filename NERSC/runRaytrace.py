...
for snap in range(0,int(nsnaps)):
    ...
    exposure = "%03d" % snap
    core = os.getenv('DC1_OBSHISTID')+'_f'+os.getenv('DC1_FILTER')+'_'+os.getenv('DC1_SENSORID')+'_E'+exposure
    ...
    ## Centroid file
    if os.getenv('DC1_CENTROIDFILE') == '1':
    ...
    outDir = os.getenv('DC1_PHOSIMOUT')
    print 'outDir = ',outDir
...
cmd = 'pipelineSet DC1_OUTPUTLIST '+outlist
print cmd
rc = os.system(cmd)
if rc <> 0 :
